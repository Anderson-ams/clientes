...
public class RestResponseEntityExceptionHandler {
	...
	public ResponseEntity<ErroApiResponse> handlerGenericException(Exception ex) {
		...
		return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(ErroApiResponse.builder()
				.description("INTERNAL SERVER ERROR").message("PLEASE INFOM THE SYSTEM ADMINISTRATOR").build());
	}
